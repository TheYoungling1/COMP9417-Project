...
Graduate-level comparison of xRFM (Beaglehole et al., 2025; arXiv:2508.10053) against XGBoost, Random Forest, and CatBoost on 5 tabular datasets.
...
The full pipeline is 20 main experiments (5 datasets × 4 models) plus interpretability and scaling sweeps. `run_all_main` runs xRFM, XGBoost, RF, and CatBoost.
